...
public class DetailPemesananController {
    ...
    @GetMapping("/detail/pemesanan")
    public void exampleReport(HttpServletResponse response) throws JRException, IOException {
        InputStream jasperStream = this.getClass().getResourceAsStream("/jasper/DetailPemesanan.jasper");
        ...
        List<DetailPemesanan> listDetailPemesanan = Arrays.asList(detailPemesanan);

        JasperReport jasperReport = (JasperReport) JRLoader.loadObject(jasperStream);
        JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, params, new JRBeanCollectionDataSource(listDetailPemesanan));
